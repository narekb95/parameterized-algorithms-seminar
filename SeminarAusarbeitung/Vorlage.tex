...
pairwise linked family of cycles of size $k$, then this family must have existed in $H'$ since we
only add objects to the drawing. Which is a contradiction to the assumption that $H' \in
\mathcal{C}$.

Now assume that $H$ results from $H'$ by an edge-contraction. Assume that $G$ does not admit
